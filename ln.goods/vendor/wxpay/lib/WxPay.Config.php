...
class WxPayConfig extends WxPayConfigInterface
{
     ...
     public static $xcx_appid;
     public static $xcx_mchid;
     public static $xcx_key;
     public static $xcx_secret;
	...
	{
		return self::$xcx_appid;
	}
	public function GetMerchantId()
	{
		return self::$xcx_mchid;
	}
