...
namespace MrstockCloud\Goods\Inneruse\V2\Goods;
 ...
 * @method Addzhengu addzhengu(array $options = []) whatFor="诊股新增",menuName="",codeMonkey="" 
 * @method Getzhengufreenumber getzhengufreenumber(array $options = []) whatFor="获取诊股设置免费次数",menuName="",codeMonkey="" 
