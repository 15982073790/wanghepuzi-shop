...
namespace MrstockCloud\Institution\Inneruse\V2\Groupframwork;
 ...
 * @method Checklender checklender(array $options = [])  
 * @method Getadminsbydepartmentid getadminsbydepartmentid(array $options = [])  
 * @method Getdepartdata getdepartdata(array $options = [])  
