...
namespace MrstockCloud\Crmbjn\Inneruse\V2\Managepool;
 ...
 * @method Getadminid getadminid(array $options = []) whatFor="随机获取adminid",codeMonkey="申长春" 
 ...
 * @method Checkprelation checkprelation(array $options = [])  
 * @method Searchpool searchpool(array $options = [])  
 * @method Getprelation getprelation(array $options = [])  
