...
use MrstockCloud\Client\Result\Result;
use Stringy\Stringy;
 ...
 */
class ServerException extends MrstockCloudException
{
    ...
    public function __construct(Result $result, $errorMessage = '', $errorCode = '')
    {
        ...
        if ($this->result->getRequest()
            && String::create($this->errorMessage)->contains($this->result->getRequest()->stringToBeSigned())) {
