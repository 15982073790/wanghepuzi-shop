...
use CxtCloud\Client\CxtCloud;
use CxtCloud\Client\Request\Traits\MagicTrait;
use MrStock\System\Helper\Config;
use MrStock\System\MJC\Container;

/**
 * Class RpcRequest
 * @package CxtCloud\Client\Request
 */
class RpcRequest
{
    use MagicTrait;
    ...
    protected function parseSdk()
    {
        ...
        if (CxtCloud::$APPCODE) {
            $this->bodyData['appcode'] = CxtCloud::$APPCODE;
        }
        if (CxtCloud::$SECRETKEY) {
            $this->bodyData['inneruse_secretkey'] = CxtCloud::$SECRETKEY;
        }
